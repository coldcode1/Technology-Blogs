...
public class SeoInjectService {
    private static final String KEYWORDS = "技术博客园,开源社区,java,springboot,IT,程序员,开发者,mysql,redis,Java基础,多线程,JVM,虚拟机,数据库,MySQL,Spring,Redis,MyBatis,系统设计,分布式,RPC,高可用,高并发";
    private static final String DES = "技术博客园,一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、RabbitMQ 等技术栈实现的社区系统";
    ...
    public Seo defaultSeo() {
        Seo seo = initBasicSeoTag();
        List<SeoTagVo> list = seo.getOgp();
        list.add(new SeoTagVo("og:title", "技术博客园"));
        ...
        list.add(new SeoTagVo("article:author", "技术博客园"));

        list.add(new SeoTagVo("author", "技术博客园"));
        list.add(new SeoTagVo("title", "技术博客园"));
